namespace Practico2
{
    public partial class Form1 : Form
    {
        ...
        {
            Application.Exit();//instrucion adecuada para poder cerrar app completamnte
        }
        ...
        private void RBVaron_CheckedChanged(object sender, EventArgs e)
        {
            if (RBVaron.Checked)
            {
                pictureBox1.Image = Properties.Resources.Hombre;//igualo el valor de la imagen a la propiedad del valor d ela imagen del hombre
            }
        }
        ...
        private void RBMujer_CheckedChanged(object sender, EventArgs e)
        {
            if (RBMujer.Checked)
            {
                pictureBox1.Image = Properties.Resources.Muujer;//igualo el valor de la imagen a la propiedad del valor d ela imagen d ela mujer
            }
        }
